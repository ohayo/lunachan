    ...
    async setupDatabase() {
        try {
            ...
            if (boards.length == 0) {
                ...
                await this.createPost("gen", "welcome to /gen/", "noia", "use common sense while posting pls\n\nthread wipes are once a week, max file size in general is 20mb. if you find any bugs with lunachan, please email contactnoia@protonmail.com thanks!", 0, 0, null, true);
                await this.createPost("anime", "welcome to /anime/", "noia", "please keep in the mind the following rule(s) before posting here:\n\n1 - no lolicon\n2 - pls dont post pirated content\n\nif you find any bugs with lunachan, please email contactnoia@protonmail.com thanks!", 0, 0, null, true);
